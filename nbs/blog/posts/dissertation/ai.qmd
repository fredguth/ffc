...
::: {.column-margin #fig-ars_magna_disc label="fig-ars_magna_disc"}
...
::: {.column-body}
![](imgs/anatomy.png){#fig-anatomy width=60% fig-align="center"}

Anatomy of an Intelligent Agent. Inspired by art in [@russell:2010]
:::
...
![Building in Harare, Zimbabwe, modelled after termite mounds. Photo by Mike Pearce.](imgs/arup_building.jpg){#fig-arup_building width="25%"}

![Cathedral termite mound, Australia. Photo by Awoisoak Kaosiowa, 2008.](imgs/termite_cathedral.jpg){#fig-termite_cathedral width="25%"}
